 ...
 * @author Cloudbuilt
 */
public class Gladiator extends PlayableCharacter{

    public Gladiator(String name, IEquipment weapon, IEquipment shield) {
        super(name, 20, 15, 200, Role.GLADIATOR, weapon, shield);
    }
